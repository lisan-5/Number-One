...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-green-400 to-blue-500 py-20 text-center text-white">
        ...
        <a href="<?php echo e(route('products')); ?>" class="px-8 py-3 bg-white text-green-600 font-semibold rounded-md hover:bg-gray-100 transition">Shop Now</a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lisan\Herd\Number_one\resources\views/welcome.blade.php ENDPATH**/ ?>